...
# ~\~ begin <<docs/01-parareal.md|parareal/abstract.py>>[init]
from __future__ import annotations
from typing import (Callable, Protocol, TypeVar, Union)

# ~\~ begin <<docs/01-parareal.md|abstract-types>>[init]
...
# ~\~ end
# ~\~ begin <<docs/01-parareal.md|abstract-types>>[1]
Mapping = Callable[[TVector], TVector]
# ~\~ end
# ~\~ begin <<docs/01-parareal.md|abstract-types>>[2]
Problem = Callable[[TVector, float], TVector]
# ~\~ end
# ~\~ begin <<docs/01-parareal.md|abstract-types>>[3]
